    ...
    <section className="min-h-screen px-6 mt-16 md:mt-40 bg-transparent w-full max-w-[100vw] overflow-x-hidden">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex flex-wrap justify-center items-baseline gap-2 sm:gap-4 md:gap-5 mt-4 md:mt-8 px-2">
          ...
          <span className="font-noto text-[32px] sm:text-[52px] md:text-[80px] font-light leading-none italic tracking-[-1.5px] md:tracking-[-4px] scale-y-[1.2] origin-bottom inline-block">
            work
          </span>
          <span className="font-inter text-[36px] sm:text-[60px] md:text-[95px] font-semibold tracking-[-1px] md:tracking-[-2px]">
            with
        ...
        <div className="flex flex-col items-center mt-4 md:mt-[10px] w-full">
          ...
          <div className="w-full pt-8 pb-8 md:pt-10 md:pb-10">
            ...
            >
              {allIcons.map((tech) => (
                <motion.div key={tech.name} variants={iconItem} className="flex flex-col items-center gap-1.5">
                  <div className="w-12 h-12 rounded-full bg-black border border-neutral-800 flex items-center justify-center shadow-lg">
                    {tech.svgPath}
                  </div>
                  <span className="text-center font-mono text-[8px] tracking-wide font-semibold text-neutral-400 uppercase leading-tight">
                    {tech.name}
                  </span>
                </motion.div>
              ))}
            ...
            <div className="hidden md:flex md:flex-col md:gap-7 md:items-center md:justify-center">
              <motion.div variants={iconRow} className="flex items-center justify-center gap-5">
                {row1.map((tech) => (
                  <motion.div key={tech.name} variants={iconItem} className="relative z-0 hover:z-30 cursor-pointer group">
        ...
        <div className="md:hidden flex items-center justify-center gap-3 mt-6 mb-2">
        ...
        <motion.div variants={fadeUp} className="relative z-10 mt-0 md:mt-[-100px]">
          <LeetCodeStats />
        </motion.div>
